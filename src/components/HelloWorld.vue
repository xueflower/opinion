  ...
  <div class="index">
    <!-- <div class="top-cont">
      <div class="input-cont" :class="{'active':indexSearch}">
        <input type="" name="" placeholder="请输入关键字搜索舆情" value="" v-model="searchkeyword" @keyup.enter="searchArtical"/>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //首页搜索事件
      searchArtical(){
        this.articalRequire.keyword = this.searchkeyword;
